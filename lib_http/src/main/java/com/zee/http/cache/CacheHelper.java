...
class CacheHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_CACHE_NAME = "myok_cache.db";
    public static final int DB_CACHE_VERSION = 1;
    public static final String TABLE_NAME = "myok__table";
    ...
    public CacheHelper() {
        super(MyOkHandlerUtils.getApplication(), DB_CACHE_NAME, null, DB_CACHE_VERSION);
    }
