...
public abstract class DataBaseDao {
     ...
     * 按条件查询对象并返回集合
     */
    public List<CacheBean> get(String selection, String[] selectionArgs) {
     ...
     * 按条件查询对象并返回集合
     */
    public List<CacheBean> get(String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String orderBy, String limit) {
        SQLiteDatabase database = openReader();
     ...
     */
    public long replace(CacheBean t) {
        SQLiteDatabase database = openWriter();
        try {
            database.beginTransaction();
     ...
     */
    public abstract CacheBean parseCursorToBean(Cursor cursor);

    /**
     * 需要替换的列
     */
    public abstract ContentValues getContentValues(CacheBean t);
}